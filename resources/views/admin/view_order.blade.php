    ...
    <div class="table-responsive">
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            <td>{{$customer->ten_khachhang}}</td>
            <td>{{$customer->sđt_khachhang}}</td>
          </tr>
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{$shipping->ten_nguoinhan}}</td>
            <td>{{$shipping->diachi_nguoinhan}}</td>
             <td>{{$shipping->sđt_nguoinhan}}</td>
             <!--<td>{{$shipping->shipping_email}}</td>-->
             <td>{{$shipping->ghichu}}</td>
