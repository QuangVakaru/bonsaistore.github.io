...
@section('admin_content')
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      Các loại cây cảnh
    </div>
    <button><li><a href="{{URL::to('/add-category-product')}}">Thêm loại sản phẩm</a></li></button>
